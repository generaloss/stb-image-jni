...
public class StbImage {
    ...
    public static native ByteBuffer loadGifFromMemory(byte[] data, int length, int[] delays, int[] width, int[] height, int[] frames, int[] channels, int desiredChannels);
    ...
    public static native ByteBuffer loadfFromMemory(byte[] data, int length, int[] width, int[] height, int[] channels, int desiredChannels);
    ...
    public static native ByteBuffer load16FromMemory(byte[] data, int length, int[] widht, int[] height, int[] channels, int desiredChannels);
